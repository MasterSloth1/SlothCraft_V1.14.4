...
public class LeadArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:lead_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:lead_armorbody")
	public static final Item body = null;
	@ObjectHolder("slothcraft:lead_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("slothcraft:lead_armorboots")
