...
public class TinArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:tin_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:tin_armorbody")
	public static final Item body = null;
	@ObjectHolder("slothcraft:tin_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("slothcraft:tin_armorboots")
