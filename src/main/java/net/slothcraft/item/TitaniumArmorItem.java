...
public class TitaniumArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:titanium_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:titanium_armorbody")
	public static final Item body = null;
	@ObjectHolder("slothcraft:titanium_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("slothcraft:titanium_armorboots")
