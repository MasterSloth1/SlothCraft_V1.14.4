...
public class UraniumArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:uranium_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:uranium_armorbody")
	public static final Item body = null;
	@ObjectHolder("slothcraft:uranium_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("slothcraft:uranium_armorboots")
