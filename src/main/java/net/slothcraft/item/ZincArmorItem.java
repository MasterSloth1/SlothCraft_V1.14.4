...
public class ZincArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:zinc_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:zinc_armorbody")
	public static final Item body = null;
	@ObjectHolder("slothcraft:zinc_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("slothcraft:zinc_armorboots")
