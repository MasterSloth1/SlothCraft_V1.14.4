...
public class SteelArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:steel_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:steel_armorbody")
	public static final Item body = null;
	@ObjectHolder("slothcraft:steel_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("slothcraft:steel_armorboots")
