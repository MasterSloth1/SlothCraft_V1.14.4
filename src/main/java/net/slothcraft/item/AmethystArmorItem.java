...
public class AmethystArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:amethyst_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:amethyst_armorbody")
	public static final Item body = null;
	@ObjectHolder("slothcraft:amethyst_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("slothcraft:amethyst_armorboots")
